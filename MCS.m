function [f_time,f_cost,f_stable,f_iter,f_reset,fy]= MCS(men_rank_list,women_rank_list,M)
%==========================================================================
% By Hoang Huu Viet
...
while (iter <= MAX_ITERS)
    ...
    [f,X,h] = find_cost_and_blocking_pairs(men_rank_list,women_rank_list,M);
    fy(end+1) = f;
    ...
    if isempty(X)
        ...
        if (f > 0)
            ...
            M = escape_local_minimum(men_rank_list,women_rank_list,M);
            continue;
        else
            break;
        end
...
%==========================================================================
function [f,X,h] = find_cost_and_blocking_pairs(men_rank_list,women_rank_list,M)
...
%==========================================================================
function [M] = escape_local_minimum(men_rank_list,women_rank_list,M)
if (rand()<=0.5)
