...
close all
%
n = 50;% 1200; %the size of SMTI instances
k = 10;%50;  %the number of instances has the same (n,p1,p2)
    ...
    for p2 = 0.5%0.0:0.1:1.0
        ...
        while (i <= k)
            ...
            if (f == true) 
                ...
                filename = ['tests1\I(',num2str(n),',',num2str(p1,'%.1f'),',',num2str(p2,'%.1f'),')-',num2str(i),'.mat'];
